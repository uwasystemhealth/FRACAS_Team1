...
class IsOwnerOrReadOnlyTestCase(TestCase):
    ...
    def test_owner_permission(self):
        ...
        self.record.record_creator = self.user.username # Set the record's creator to the user's email.
        self.record.save()
    ...
    def test_non_owner_permission(self):
        ...
        another_user = User.objects.create_user(
            first_name='Jane', last_name='Doe', email='jane@example.com', password='test1234'
        )
        # Mock the username attribute for the test
        ...
        self.record.record_creator = self.user.username # Set the record's creator to the original user's email.
        self.record.save()
